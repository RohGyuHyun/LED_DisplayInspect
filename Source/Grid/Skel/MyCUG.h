...
public:
	int m_nBeforeDeviceX[5];
	int m_nBeforeDeviceY[5];
	
	//20161130 nht
	int m_nMoveBeforeDeviceX[3];
	int m_nMoveBeforeDeviceY[3];
	...
	//20160909 sc
	virtual void SetGrid_LED(int cols,int rows,int grabcnt,int one_insp_cnt);
	virtual void SetGridOkNg_LED(int OkNg,int col,int row,int grabcnt);
