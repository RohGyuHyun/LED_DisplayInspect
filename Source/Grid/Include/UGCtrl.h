...
public:
	...
	BOOL AttachGrid(CWnd * wnd,UINT ID,int cols,int rows,int grabcnt);
	...
	//20160909 sc
	virtual void SetGrid_LED(int cols,int rows,int grabcnt);
	virtual void SetGridOkNg_LED(int OkNg,int col,int row);
